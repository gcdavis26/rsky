...
public:
	Guidance(const Vector12d& x, const Vector2d& n_bounds, const Vector2d& e_bounds, int numpasses, double cruise_speed, double yaw_rate, double takeoff, double pgain, double vgain);
