...
static double GetMedian(double* values, int n);
...
void MLX90640_CalculateTo(uint16_t* frameData, const paramsMLX90640* params, double emissivity, double tr, double* result)
{
    double vdd;
    double ta;
    double ta4;
    ...
    gain = (double)params->gainEE / (int16_t)frameData[778];
...
void MLX90640_GetImage(uint16_t* frameData, const paramsMLX90640* params, double* result)
{
    double vdd;
    double ta;
    double gain;
...
double MLX90640_GetVdd(uint16_t* frameData, const paramsMLX90640* params)
{
    double vdd;
...
double MLX90640_GetTa(uint16_t* frameData, const paramsMLX90640* params)
{
    int16_t ptat;
    double ptatArt;
    double vdd;
...
//------------------------------------------------------------------------------
void MLX90640_BadPixelsCorrection(uint16_t* pixels, double* to, int mode, paramsMLX90640* params)
{
    double ap[4];
    uint8_t pix;
    uint8_t line;
...
static void ExtractPTATParameters(uint16_t* eeData, paramsMLX90640* mlx90640)
{
    ...
    alphaPTAT = (eeData[16] & MLX90640_NIBBLE4_MASK) / POW2(14) + 8.0;
...
static void ExtractTgcParameters(uint16_t* eeData, paramsMLX90640* mlx90640)
{
    mlx90640->tgc = (int8_t)MLX90640_LS_BYTE(eeData[60]) / 32.0;
}
...
static void ExtractKsTaParameters(uint16_t* eeData, paramsMLX90640* mlx90640)
{
    mlx90640->KsTa = (int8_t)MLX90640_MS_BYTE(eeData[60]) / 8192.0;
}
...
static void ExtractKsToParameters(uint16_t* eeData, paramsMLX90640* mlx90640)
{
    ...
    mlx90640->ksTo[0] = (int8_t)MLX90640_LS_BYTE(eeData[61]) / (double)KsToScale;
    mlx90640->ksTo[1] = (int8_t)MLX90640_MS_BYTE(eeData[61]) / (double)KsToScale;
    mlx90640->ksTo[2] = (int8_t)MLX90640_LS_BYTE(eeData[62]) / (double)KsToScale;
    mlx90640->ksTo[3] = (int8_t)MLX90640_MS_BYTE(eeData[62]) / (double)KsToScale;
